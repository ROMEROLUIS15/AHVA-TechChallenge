...
/// <summary>
/// Iconos SVG inline reutilizados en las vistas (evita depender de una librería de
/// iconos externa; se usan alternativas cuando el recurso original no está disponible).
/// </summary>
public static class IconSvg
{
    ...
    /// <summary>Ojo tachado: se muestra cuando la contraseña está oculta.</summary>
    ...
    public const string Blocked =
        "<svg width='34' height='34' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><circle cx='12' cy='8' r='4'/><path d='M6 21v-1a4 4 0 0 1 4-4h1'/><circle cx='17' cy='17' r='5'/><path d='M15 15l4 4'/></svg>";

    public const string Support =
        "<svg width='22' height='22' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M4 15v-3a8 8 0 0 1 16 0v3'/><path d='M18 19a2 2 0 0 1-2 2h-1'/><rect x='2' y='15' width='4' height='6' rx='1'/><rect x='18' y='15' width='4' height='6' rx='1'/></svg>";
